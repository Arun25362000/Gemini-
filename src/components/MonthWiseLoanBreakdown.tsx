...
import { LoanPrincipalInterestChart } from './LoanPrincipalInterestChart';
...
export const MonthWiseLoanBreakdown: React.FC<MonthWiseLoanBreakdownProps> = ({
  ...
  const handleSelectLoanForChart = (loanId: string) => {
  ...
  return (
    <div className={cn("space-y-6", isAndroid && "space-y-4")}>
      {/* Principal vs. Interest Breakdown Recharts Visualization */}
      <div ref={chartContainerRef}>
        <LoanPrincipalInterestChart
          ...
          onSelectLoan={(loanId) => setSelectedLoanId(loanId)}
        />
      </div>
                                  ...
                                  <thead>
                                    <tr className="bg-slate-50/75 border-b border-slate-200/80 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                                      ...
                                      <th 
                                        ...
                                        className="px-2 sm:px-2.5 py-2.5 w-24 sm:w-26 text-center border-r border-slate-200/60 cursor-pointer hover:bg-slate-100 transition-colors group select-none"
                                      >
                                        <div className="flex items-center justify-center gap-1.5">
                                          Status
                                      ...
                                      <th className="px-2 py-2.5 w-14 text-center select-none">
                                        P&I
                                      </th>
                                    </tr>
                                  </thead>
                                      ...
                                      return (
                                        <tr 
                                          ...
                                          className={cn(
                                            ...
                                            isSelectedLoan && "bg-purple-50/70 ring-1 ring-purple-300"
                                          )}
                                        >
                                          ...
                                          <td className="px-2 sm:px-2.5 py-2.5 w-24 sm:w-26 text-center border-r border-slate-200/60">
                                            <span className={cn(
                                          ...
                                          <td className="px-2 py-2.5 w-14 text-center">
                                            <button
                                              ...
                                              className={cn(
                                                "p-1.5 rounded-lg transition-all cursor-pointer inline-flex items-center justify-center",
                                                isSelectedLoan
                                                  ? "bg-purple-600 text-white shadow-xs"
                                                  : "bg-slate-100 text-slate-500 hover:bg-purple-100 hover:text-purple-700"
                                              )}
                                              title="View Principal vs Interest Chart"
                                            >
                                ...
                                {getSortedMonthLoans(monthGroup.loans).map((item, lIdx) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      >
                                        <BarChart2 className="w-3.5 h-3.5" />
                                        <span>{isSelectedLoan ? 'Active in P&I Breakdown' : 'View P&I Breakdown'}</span>
                                      </button>
                                    </div>
                                  );
                                })}
