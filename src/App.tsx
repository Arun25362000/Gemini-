                  ...
                  >
                    <div>
                      ...
                      <div className="mt-0.5 text-xl sm:text-2xl font-black text-purple-950 tracking-tight truncate">
                        ₹{totalActiveLoanAmount.toLocaleString('en-IN')}
                      </div>
                    </div>
                    <div className="mt-2.5 pt-2 border-t border-purple-100/90 grid grid-cols-2 gap-2 text-[10.5px]">
                      <div className="flex flex-col">
                        ...
                        <span className="font-bold text-emerald-700 truncate">₹{totalActiveLoanPaid.toLocaleString('en-IN')}</span>
                      </div>
                      <div className="flex flex-col text-right">
                        <span className="font-semibold text-slate-500">Total Interest Paid</span>
                        <span className="font-bold text-indigo-700 truncate">₹{totalActiveInterestPaid.toLocaleString('en-IN')}</span>
                      </div>
                    </div>
                  </motion.div>
                );
                          ...
                          >
                            <div className="flex items-center gap-3.5 min-w-0">
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="text-xs text-slate-500 font-medium mt-0.5">
                                  {isGroupExpanded ? 'Click to collapse loan details & schedule' : `Due: ₹${remainingTotal.toLocaleString('en-IN')} • Click to expand`}
                                </p>
                              </div>
                            </div>
                              ...
                              >
                                <div className="p-5 sm:p-6 space-y-6">
                                  ...
                                  <div className="p-5 sm:p-8 bg-indigo-600 text-white rounded-[2rem] shadow-sm relative overflow-hidden">
                                    ...
                                    <div className="text-3xl sm:text-5xl font-black mb-1">₹{remainingTotal.toLocaleString('en-IN')}</div>
                                    <p className="text-[10px] sm:text-xs text-indigo-200 font-bold mb-6">₹{remainingPrincipal.toLocaleString('en-IN')} Principal</p>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 sm:gap-8 pt-5 sm:pt-6 border-t border-white/10">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-lg sm:text-xl font-bold">₹{l.approvedAmount?.toLocaleString('en-IN')}</p>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-500">Paid for {format(new Date(collectionYear, collectionMonth - 1, 1), "MMMM yyyy")} • {monthlyPaidContributions.length} Members</p>
                          </div>
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-500">Principal + Interest for {format(new Date(collectionYear, collectionMonth - 1, 1), "MMMM yyyy")} • {monthlyPaidLoanPayments.length} Repayments</p>
                          </div>
                        </div>
                                        ...
                                        <td className="px-3 sm:px-3.5 py-3 border-r border-slate-200/60">
                                          <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-slate-500 font-medium">
                                              ₹{p.principal.toLocaleString('en-IN')} (P) + ₹{p.interest.toLocaleString('en-IN')} (I)
                                            </span>
                                          </div>
                                        </td>
                                        <td className="px-3 sm:px-3.5 py-3 border-r border-slate-200/60">
