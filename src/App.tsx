                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                        ...
                        <div className="bg-gradient-to-br from-amber-50/90 via-amber-50/40 to-white border-2 border-amber-200/90 rounded-2xl p-5 shadow-xs">
                          ...
                          <div className="text-lg font-black text-slate-900">
                            â‚¹{monthlyLoanPrincipalCollected.toLocaleString('en-IN')} <span className="text-xs font-normal text-slate-400">+</span> <span className="text-amber-700">â‚¹{monthlyLoanInterestCollected.toLocaleString('en-IN')}</span>
                          </div>
                                    ...
                                    {sortedLoanPayments.map((p, rowIdx) => (
                                      <tr key={`coll-loan-p-${p.id}`} className="hover:bg-slate-50/70 transition-colors">
                                        ...
                                        <td className="px-3 sm:px-3.5 py-3 font-semibold text-slate-700 border-r border-slate-200/60">
                                          â‚¹{p.principal.toLocaleString('en-IN')}
                                        </td>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-bold text-slate-900">
                    ...
                    )?.displayName || editingContribution.userEmail.splitxœÔ–ÍRÛ0ÇïyŠ\’Ì Øh§©“–aze˜áØéA¶7ŽŠ,y,9À —¾U_‡'©lÙÁevÚú’H+í®þûÓÇxôq4ùìy@ç¼lÙé¼˜m–ƒnÕípÂiˆ"N•:§).†!—Ñh¼ÑD¥°’B“Pò¸îáT#yëû†d6\ž¦²Æß¾O¯òåŒÂDVhpX ômf¢Š"1:Gl(/pq‡1ÓL$g&£œ……fRL©£‘K# )ÎÖT$fþ'°X‚Bý©ëi|ÓéÔâ lŒ9œW)Žqªiž žViMàaâÜ’ôš¬
Î!#Ç&µ†'>äÆoŒ1™Ýpec^ÿÔCfFæ–êïL³*GjÒ,ÊÒD…šç&_2k7˜ˆY"M d¡9H„èÒÖûë ]jªõ:&nÛûŠã$4+';uLÝ´N[C›â¦­B†³èÊókÀ¨jMse”Å£^@ÚˆÜEbÜ3 Z39„ì–m¡1Ì8$Î©P¬Ì‚PÞ@5<èõìÚR6{X,õzg|€¡SÌ)É›†×ë5ÓØ°Ü¶ª5å5áIó¯1ú~_5Êo^Å±n[•.;;f-7˜Ïw‚Ïúý÷TÇÀ…‘ÄÍg©ú÷©Ds@ˆäÿ³^Ã‹lÒòÌî!óÉÖáÒšþ•ÖûodÒªñj,ë³¾§Ûy8â#È49vžÇ5÷î«?¤…¹;_¾cŸP<Þ-Æ†uzîàŸ!uÕÆ]€3*"äN}ŸÑ~/aŠ,6‰¶åØOˆ™"Ü¾vv@{ÙyêIå5½³s;;¥j¶
ÐH³ÎUD¹y­œ@Å‡‰–*¡ÐæyóµPš­n›¦½Æ÷Öù’nìkN½Jm'çŽÎÀKeuÔìXv†na¼SÁRS ‹ì˜ zVMÞ?   ÿÿ …
=